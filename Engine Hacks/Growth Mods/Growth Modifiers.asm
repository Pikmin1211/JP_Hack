...
Growth_Mod_Check:		@Check for item in inventory that modifies growths
@mov		r2,#0x0			@Here we zero out the seven bytes in the stack allocated to our total growth mods
...
@mov	r1,r10
@ldrb	r1,[r1,r5]
@add	r0,r1			@Item-mod bonus
add 	r0, r8			@Afa's drops bonus
mov		r1,r9
cmp		r1,#0x0
beq		Growth_Pos
ldsb	r1,[r1,r5]		@Growth mod item's modifier - can be positive or negative
add		r0,r1
cmp		r0,#0x0
bge		Growth_Pos
mov		r0,#0x0
