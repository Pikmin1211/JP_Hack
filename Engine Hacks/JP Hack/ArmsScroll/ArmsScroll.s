...
ArmsScrollCanUnitGetSRank:
	...
	// has an s rank?
	mov r2, #0x28 // weapon ranks

	ArmsScrollCanUnitGetSRankLoop:
	ldrb r0, [r4, r2]
	cmp r0, #251
	beq ArmsScrollCanUnitGetSRankRetFalse
	add r2, #1
	cmp r2, #0x30 // end of weapon ranks
	beq ArmsScrollCanUnitGetSRankRetTrue
	b ArmsScrollCanUnitGetSRankLoop
